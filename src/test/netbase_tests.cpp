...
{
    BOOST_CHECK(TestSplitHost("www.CryptobugCoin.org", "www.CryptobugCoin.org", -1));
    BOOST_CHECK(TestSplitHost("[www.CryptobugCoin.org]", "www.CryptobugCoin.org", -1));
    BOOST_CHECK(TestSplitHost("www.CryptobugCoin.org:80", "www.CryptobugCoin.org", 80));
    BOOST_CHECK(TestSplitHost("[www.CryptobugCoin.org]:80", "www.CryptobugCoin.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:33399", "127.0.0.1", 33399));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:33399", "127.0.0.1", 33399));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:33399", "::ffff:127.0.0.1", 33399));
    BOOST_CHECK(TestSplitHost("[::]:33399", "::", 33399));
    BOOST_CHECK(TestSplitHost("::33399", "::33399", -1));
    BOOST_CHECK(TestSplitHost(":33399", "", 33399));
    BOOST_CHECK(TestSplitHost("[]:33399", "", 33399));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:33399", "127.0.0.1:33399"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:33399", "[::]:33399"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
